...
const StatsSection: React.FC = () => {
  ...
  return (
    <section className="
      ...
      dark:from-black dark:via-gray-900 dark:to-slate-900
    ...
    ">
      ...
      <div
        data-aos="zoom-in"
        className="
          inline-flex items-center px-3 sm:px-5 py-2 sm:py-3 rounded-full
          bg-blue-100/60 text-blue-700
          dark:bg-blue-500/10 dark:text-blue-400
          mb-3 sm:mb-5 text-sm sm:text-base
          transition-colors
        "
      >
      ...
      <div className="absolute inset-0 opacity-10 pointer-events-none select-none">
        <div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23a3a3a3' fill-opacity='0.08'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`
          }}
        ></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="
            text-2xl xs:text-3xl sm:text-4xl md:text-5xl font-bold
            ...
            return (
              ...
              >
                <div
                  ...
                  `}
                >
                  <IconComponent className="w-8 h-8 sm:w-10 sm:h-10 text-white drop-shadow" />
                </div>
                <div className="
