      ...
      <main className="container mx-auto px-4 py-8 sm:py-12 mt-14 lg:py-16 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          <motion.div
            ...
            className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-blue-500/10 text-blue-400 mb-4 sm:mb-6"
          >
          ...
          <motion.h1 
            ...
            className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-400"
          >
        ...
        >
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-2xl overflow-hidden border border-gray-700/50">
            {/* Tab Navigation */}
          ...
          {recentOrderId && activeTab === 'track' && (
            ...
            >
              <div className="inline-flex items-center px-4 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl bg-green-500/10 text-green-400 shadow-lg border border-green-500/20">
                <svg className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                </svg>
                <div className="text-left">
                  <p className="font-medium text-base sm:text-lg">Order Placed Successfully!</p>
                  <p className="text-xs sm:text-sm text-green-400/80">Order ID: {recentOrderId}</p>
                </div>
              </div>
            </motion.div>
          )}
